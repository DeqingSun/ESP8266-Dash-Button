...
public class rev_Class_f
{
    ...
    {
        byte[] localByteArray = rev_Class_l_maybe_util.b(paramChar);    //v0
        ...
        byte[] localByteArray2 = rev_Class_l_maybe_util.b((char)((int)localObjectClassM.getValue()));  //v0
    ...
    public byte[] a()
    {
        return new byte[] { 0, rev_Class_l_maybe_util.a((byte)4, this.a), 0, rev_Class_l_maybe_util.a((byte)5, this.b), 0, rev_Class_l_maybe_util.a((byte)6, this.c), 0, rev_Class_l_maybe_util.a((byte)7, this.d) };
    }
